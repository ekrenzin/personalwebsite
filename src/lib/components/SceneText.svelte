...
<div class="p-8 mt-10 " transition:fade >
    <div style={`opacity: ${opacity}; max-width: 1000px;  margin: auto; border-radius: 20px`} class="py-4 px-2 backdrop-blur bg-white/500 ">
	...
	<div class="final">
	  <div class="text-center">
        ...
        text-base text-white
        sm:text-lg
        md:mt-5 md:text-xl md:max-w-3xl px-8 py-2 rounded-full pulse-accent bg-sky-500 mx-4">Launch</button></a>
	  </div>
	</div>
    {/if}
</div>
